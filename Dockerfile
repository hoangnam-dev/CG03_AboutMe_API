...
COPY src/Portfolio.Api/Portfolio.Api.csproj \
     src/Portfolio.Api/

COPY src/Portfolio.Application/Portfolio.Application.csproj \
     src/Portfolio.Application/

COPY src/Portfolio.Infrastructure/Portfolio.Infrastructure.csproj \
