...
```text
AuthServiceTests.ValidCredentialsReturnBearerToken
AuthServiceTests.InvalidCredentialsUseGenericFailure
JwtAccessTokenIssuerTests.IssuesExpectedIssuerAudienceSubjectAndRole
...
LoginRateLimitTests.ExcessRequestsReturnProblemDetailsAndRetryAfter
```
