    ...
    public ValidateOptionsResult Validate(string? name, UploadOptions options) =>
        ...
        options.MaxHeroImageHeight is >= 1 and <= 16_384
            ...
            : ValidateOptionsResult.Fail(
                $"Upload:MaxFileSize must be between 1 and {UploadOptions.MaximumAllowedFileSize} bytes; Upload:MaxHeroImageWidth and Upload:MaxHeroImageHeight must be between 1 and 16384 pixels.");
}
